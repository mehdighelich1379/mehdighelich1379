...
- **Persian RAG System (Production-ready)**  
  Domain-specific **Retrieval-Augmented Generation (RAG)** for Persian HR, hiring, and resume queries.  
  Built with **FAISS vector search**, **sentence embeddings**, **cosine similarity guardrails**, **FastAPI backend**, and **Gradio RTL UI**.  
  ✅ Grounded answers • ✅ Out-of-domain rejection • ✅ Modular architecture

- **Persian Text Summarization (mT5-XLSum)**  

- **Persian NER (Transformer-based)**  
